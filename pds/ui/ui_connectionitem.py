...
class Ui_ConnectionItem(object):
    ...
    def retranslateUi(self, ConnectionItem):
        ConnectionItem.setWindowTitle(QtWidgets.QApplication.translate("ConnectionItem", "ConnectionItem", None, QtWidgets.QApplication.UnicodeUTF8))
        self.button.setText(QtWidgets.QApplication.translate("ConnectionItem", "Connect", None, QtWidgets.QApplication.UnicodeUTF8))
